...
def marker_click(marker):
    path_1.__del__
    marker_3.set_position(marker_2.position[0],marker_2.position[1])
    map_widget.set_path([marker_3.position, marker_3.position])
...
#path_1.remove_position(marker_2.position,marker_3.position)
# path_1.add_position(...)
